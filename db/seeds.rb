...
# 더미 글 생성 & 더미 댓글 생성
#여자는 짝수, 남자는 홀수
post_1 = Post.create(name: "남자2호(모두에게호감신청함)", owner_id: "1", sex: "남자", selfintroduction: "안녕하세요", status: "솔로", age: '23', home: '서울')
post_2 = Post.create(name: "남자1호(싱글)", owner_id: "3", sex: "남자", selfintroduction: "굿모닝하세요", status: "솔로", age: '23', home: '서울')
post_3 = Post.create(name: "여자2호(싱글)", owner_id: "2", sex: "여자", selfintroduction: "굿나잇하세요", status: "솔로", age: '23', home: '경기남부')
...
post_7 = Post.create(name: "남자5호(싱글아님)", owner_id: "5", sex: "남자", selfintroduction: "저는보라카이갑니다", status: "연애중", age: '23', home: '서울')
post_8 = Post.create(name: "남자6호(싱글)", owner_id: "7", sex: "남자", selfintroduction: "코딩재밌다", status: "솔로", age: '23', home: '서울')
post_9 = Post.create(name: "여자9호(싱글)", owner_id: "10", sex: "여자", selfintroduction: "안녕히계세요", status: "솔로", age: '23', home: '경상남도')
post_10 = Post.create(name: "남자10호(싱글)", owner_id: "9", sex: "남자", selfintroduction: "안녕히계세요", status: "솔로", age: '23', home: '경상남도')
